...
const menu = [
  ...
  {name: 'Gimbap Sushi 2', items},
  {name: 'Gimbap Sushi 3', items},
];
    ...
    <>
      ...
      {menu.map(({name, items: menuItems}, index) => (
        <View
          ...
          key={index}
          onLayout={({nativeEvent: {layout: {y: anchor}}}) => onMeasurement(index, {name, anchor: anchor - 142})}
        >
